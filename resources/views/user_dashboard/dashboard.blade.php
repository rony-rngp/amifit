                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="mb-4 col-md-6 {{ $last_user_info->can_you_perform_a_bodyweight_squat == 'yes' ? '' : 'd-none' }}" id="max_reps_at_bodyweight_div">
                                                <label class="form-label" for="max_reps_at_bodyweight">Max Reps at Bodyweight<i class="text-danger">*</i></label>
                                                <input type="number" class="form-control" {{ $last_user_info->can_you_perform_a_bodyweight_squat == 'yes' ? 'required' : '' }} name="max_reps_at_bodyweight" id="max_reps_at_bodyweight" value="{{ $last_user_info->max_reps_at_bodyweight }}" >
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="mb-4 col-md-6 {{ $last_user_info->can_you_perform_a_push_up == 'yes' ? '' : 'd-none' }}" id="max_reps_at_push_up_div">
                                                <label class="form-label" for="max_reps_at_push_up">Max Reps at Push-Up<i class="text-danger">*</i></label>
                                                <input type="number" class="form-control" {{ $last_user_info->can_you_perform_a_push_up == 'yes' ? 'required' : '' }} name="max_reps_at_push_up" id="max_reps_at_push_up" value="{{ $last_user_info->max_reps_at_push_up }}" >
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="mb-4 col-md-6 {{ $last_user_info->can_you_perform_a_pull_up == 'yes' ? '' : 'd-none' }}" id="max_reps_at_pull_up_div">
                                                <label class="form-label" for="max_reps_at_pull_up">Max Reps at Pull-Up<i class="text-danger">*</i></label>
                                                <input type="number" class="form-control" {{ $last_user_info->can_you_perform_a_pull_up == 'yes' ? 'required' : '' }} name="max_reps_at_pull_up" id="max_reps_at_pull_up" value="{{ $last_user_info->max_reps_at_pull_up }}" >
