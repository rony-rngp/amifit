<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }} mt-6">
        ...
        <li class="menu-item {{ request()->routeIs('admin.change_password') ? 'active' : '' }}">
            <a href="{{ route('admin.change_password') }}" class="menu-link">
        ...
        <li class="menu-item {{ request()->is('admin/plans*') ? 'active' : '' }}">
            <a href="{{ route('admin.plans.index') }}" class="menu-link">
                ...
                <div class="text-truncate">Plans</div>
            </a>
        </li>
        ...
        <li class="menu-item {{ request()->is('admin/why-choose*') ? 'active' : '' }}">
            <a href="{{ route('admin.why-choose.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-cabinet"></i>
                <div class="text-truncate">Why Choose Amifit</div>
            </a>
        </li>
