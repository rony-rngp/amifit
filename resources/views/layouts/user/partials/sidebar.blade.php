<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->routeIs('user.dashboard') ? 'active' : '' }} mt-6">
        ...
        <li class="menu-item {{ request()->routeIs('user.change_password') ? 'active' : '' }}">
            <a href="{{ route('user.change_password') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-key"></i>
                <div class="text-truncate">Change Password</div>
            </a>
        </li>

        <li class="menu-item {{ request()->is('user/my-orders') || request()->is('user/order-details*') ? 'active' : '' }}">
            <a href="{{ route('user.my_orders') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-cart"></i>
                <div class="text-truncate">My Orders</div>
            </a>
        </li>
