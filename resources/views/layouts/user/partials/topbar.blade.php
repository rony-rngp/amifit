    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item lh-1 me-4">
                <a class="github-button" href="{{ route('user.dashboard') }}" data-icon="octicon-star" data-size="large" data-show-count="true" >{{ auth()->user()->name }}</a>
            </li>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('user.change_password') }}"> <i class="bx bx-key bx-md me-3"></i><span>Change Password</span> </a>
                    </li>
