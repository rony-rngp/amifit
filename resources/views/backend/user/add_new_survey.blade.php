    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-center mb-4 alert bg-success p-5" style="font-size: 17px">Add New Survey for {{ $user->email }}</p>
                ...
                @php($user_info = $user->last_user_info)
                <form class="free_assessment_form" action="{{ route('admin.users.add_new_survey', $user->id) }}" method="post">
                    @csrf
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-4">
                                        <div class="d-flex justify-content-between final_btn">
                                            <a href="javascript:void(0)" onclick="prev_step('step_6', '5')" class="btn btn-warning"><i class="bx bxs-arrow-to-left"></i> Previous Step</a>
                                            <button type="submit" class="btn btn-primary validate">Add New Survey</button>
                                        </div>
                                    </div>
                ...
                $.ajax({
                    ...
                    beforeSend: function(){
                        ...
                        if(json['result'] == "success"){
                            ...
                            showToast('success', 'topLeft', 'Survey added successfully');
