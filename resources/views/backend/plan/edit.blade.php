        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.plans.update', $plan->id) }}" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('patch')
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    <label class="form-label" for="name">Plan Name <i class="text-danger">*</i></label>
                                    <input type="text" class="form-control" name="name" id="name" value="{{ $plan->name }}" required >
                                    <span class="text-danger">{{ $errors->has('name') ? $errors->first('name') : '' }}</span>
                                </div>

                                <div class="mb-4 col-md-6">
                                    <label class="form-label" for="duration">Duration (Monthly) <i class="text-danger">*</i></label>
                                    <input type="number" class="form-control" name="duration" id="duration" value="{{ $plan->duration }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="number" step="any" class="form-control" name="price" id="price" value="{{ $plan->price }}" required >
                                    <span class="text-danger">{{ $errors->has('price') ? $errors->first('price') : '' }}</span>
                                </div>

                                <div class="mb-4 col-md-6">
                                    <label class="form-label" for="discount">Discount (%) <i class="text-danger">*</i></label>
                                    <input type="number" class="form-control" name="discount" id="discount" value="{{ $plan->discount }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="badge_title" id="badge_title" value="{{ $plan->badge_title }}" required >
                                ...
                                <div class="col-md-12">
                                    @foreach(json_decode($plan->options, true) ?? [] as $option)
                                    <div class="row" id="inputFormRow1">
                                        <div class="form-group col-md-6 mb-4">
                                            <label class="form-label" for="status">Options <i class="text-danger">*</i></label>
                                            <input type="text" value="{{ $option }}" required name="options[]" class="form-control">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <a href="javascript:void(0)" style="margin-top: 24px;" class="btn btn-sm btn-danger" id="removeRow1"><i class=" bx bx-trash"></i></a>
                                        </div>
                                    </div>
                                   @endforeach
                                </div>
