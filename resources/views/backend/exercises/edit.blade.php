            ...
            <div class="col-xl">
                <div class="card mb-6">
                    <div class="d-flex justify-content-between align-items-center border-bottom">
                        <h5 class="card-header">Edit {{ $exercise->id > 3054 ? 'Custom' : '' }} Exercise</h5>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('admin.exercises.update', $exercise->id) }}" enctype="multipart/form-data" method="post">
                            @csrf
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="Exercise" id="Exercise" value="{{ $exercise->Exercise }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="Difficulty_Level" id="Difficulty_Level" value="{{ $exercise->Difficulty_Level }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="Target_Muscle_Group" id="Target_Muscle_Group" value="{{ $exercise->Target_Muscle_Group }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="Prime_Mover_Muscle" id="Prime_Mover_Muscle" value="{{ $exercise->Prime_Mover_Muscle }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="Primary_Equipment" id="Primary_Equipment" value="{{ $exercise->Primary_Equipment }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="Body_Region" id="Body_Region" value="{{ $exercise->Body_Region }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="Force_Type" id="Force_Type" value="{{ $exercise->Force_Type }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="url" class="form-control" name="Short_YouTube_Demonstration" id="Short_YouTube_Demonstration" value="{{ $exercise->Short_YouTube_Demonstration }}" >
